...
public class ActTaskServiceImpl implements ActTaskService {
    ...
    /**
     * @MethodName: transferAssignee
     * @Description 流程转交
     * @Param: [taskId ：任务id, userCode :被转对象id]
     * @Return: void
     * @Author: liyao
     ...
     * @Description 根据 taskId 获取单个task 对象
     * @Param: [taskId]
    ...
    public Boolean suspendProcessInstance(String processInstanceId) {
        ProcessInstanceQuery  processInstanceList = runtimeService.createProcessInstanceQuery().processInstanceId(processInstanceId);
        ProcessInstance instance = processInstanceList.singleResult();
        if( instance!=null ){
    ...
    /**
     * @MethodName: activeProcessInstance
     * @Description 流程激活
     * @Param: [processInstanceId]
     * @Return: java.lang.Boolean
     * @Author: liyao
     ...
     */
    @Override
    public Boolean activeProcessInstance(String processInstanceId) {
        ProcessInstanceQuery  processInstanceList = runtimeService.createProcessInstanceQuery().processInstanceId(processInstanceId);
        ProcessInstance instance = processInstanceList.singleResult();
        if( instance!=null ){
    ...
    /**
     * @MethodName: getProcessByTaskId
     * @Description 根据 taskId 获取到 流程定义对象
     * @Param: [taskId]
...
//        vars.put("title","");
     ...
     */
    @Override
    public ProcessInstance startProcess(String procDefKey, String businessTable, String businessId, String title, Map<String, Object> vars) {
    ...
    public String getFormKey(String procDefId, String taskDefKey) {
        ...
        if (StringUtils.isNotBlank(procDefId)) {
            if (StringUtils.isNotBlank(taskDefKey)) {
                try {
                    TaskFormData formData = formService.getTaskFormData(taskDefKey);
...
//                .generateDiagram(bpmnModel, "png", activeActivityIds);
    ...
    /**
     * @MethodName: jump2TargetFlowNode
     * @Description 流程中单个节点跳转
     * @Param: [taskKey, taskId]
     * @Return: void
     * @Author: liyao
     * @Date: 2019/10/28 13:33
     */
    @Override
    public void jump2TargetFlowNode(String taskKey, String taskId) {
        ...
        // 目标活动节点
        ActivityImpl nextActivityImpl = ((ProcessDefinitionImpl) definition).findActivity(taskKey);
